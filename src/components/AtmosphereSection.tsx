      ...
      <div className="relative z-10 container mx-auto px-6 text-center max-w-2xl">
        ...
        <div className="mt-16 flex items-center justify-center gap-6">
          {["Lampe", "Opeka", "Staklo", "Koža"].map((word, i) => (
            <span
              key={i}
              className="text-xs uppercase tracking-[0.25em] text-muted-foreground/40 border border-border/30 px-4 py-2 rounded-sm"
            >
              {word}
            </span>
          ))}
